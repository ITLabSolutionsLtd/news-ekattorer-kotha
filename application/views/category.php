    ...
    <div class="container">
        <div class="page-wrap">
            <div class="section-title-style">
                <h1 class="overlay-title"><?php echo $cat_segment; ?></h1>
                <h3 class="child-overlay-title"><?php echo $cat_segment; ?></h3>
            </div>
            <div class="row">
                <div class="col-xl-9 col-lg-9">
                    <div class="row" id="load_data_table">
    
                    <?php if($category_wise_news){
                        $count = 0;
                        foreach($category_wise_news as $row){
                            ...
                            ?>
                            <?php if (next($category_wise_news)==false) {?> 
