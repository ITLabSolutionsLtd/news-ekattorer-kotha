                                                            ...
                                                            <tr>
                                                                <td style="padding-top:20px;padding-bottom:20px" align="center" valign="top">
                                                                    <table border="0" cellpadding="0" cellspacing="0" align="center">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="background-color: #2cb66e; border-radius: 50px;" align="center" class="ctaButton"> 
                                                                                <form action="<?php echo base_url('verification')?>" method="post">
                                                                                    <?php echo form_hidden('email', $email); ?>
                                                                                    <button type="submit" style="background-color: #2cb66e; padding: 12px 35px;color:#fff;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:13px;font-weight:600;font-style:normal;letter-spacing:1px;line-height:20px;text-transform:uppercase;text-decoration:none;display:block"
                                                                                         class="text">Confirm Email
                                                                                    </button>
                                                                                </form>
