$(document).ready(function() {
  ...
  var base_url = 'http://localhost/prothomalo-live/';
  var body = $("body"),
  ...
  if ($("body.layout-dark.layout-transparent").length > 0) {
    ...
    $("#ll-switch").on("click", function() {
      $(".sidebar-background").css(
        "background-image",
        base_url+"assets/app-assets/img/sidebar-bg/01.jpg"
      );
    });
  }
  ...
  $(".cz-bg-color span").on("click", function() {
    ...
    if (bgColor == "white") {
      $(".logo-img img").attr("src", base_url+"assets/app-assets/img/logo-dark.png");
    } else {
      if (
        $(".logo-img img").attr("src") == base_url+"assets/app-assets/img/logo-dark.png"
      ) {
        $(".logo-img img").attr("src", base_url+"assets/app-assets/img/logo.png");
      }
    }
  });
  ...
  var normalClick = localStorage.getItem('normalBtnClicked');
  ...
  $("#dl-switch").on("click", function() {
    ...
    if ($("body").hasClass("layout-transparent")) {
      ...
      $(".sidebar-background").css(
        "background-image",
        base_url+"url(assets/app-assets/img/sidebar-bg/01.jpg)"
      );
      $(".app-sidebar").attr("data-background-color", "black");
    } else {
